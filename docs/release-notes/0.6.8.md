...
## Móvil
- Restored diagnostics log file manejo and se mejoró sync diagnostics behavior.
- Mejorado notification scheduling reliability on Android.
...
## Historial completo de cambios (since 0.6.7)
