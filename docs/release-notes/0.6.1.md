...
## Destacados
- Escritorio calendar now supports month/year navigation, with clearer project focusing and waiting/someday visibility fixes.
- Sync + attachments reliability upgrades across desktop and mobile, including safer edits during background sync.
- Móvil stability improvements: date picker cancel crash fix, long title alignment, and attachment sync soporte.
...
## Historial completo de cambios (since 0.6.0)
