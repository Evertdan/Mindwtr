...
- Móvil Dropbox setup runs its first sync after OAuth and enables the connection on success; failed attempts restore the last proven setup.
...
## Escritorio Integration & Distribution
