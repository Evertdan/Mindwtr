...
- Agregado Guided Mind Sweep prompt groups and localized strings across supported locales.
- Agregado desktop and mobile Guided Mind Sweep Inbox flows.
- Agregado Weekly Review inbox processing and a follow-up today review action.
- Agregado quick process submit shortcut on desktop.
- Agregado mobile bulk organize review tasks by area.
- Agregado manual task ordering within Board status columns and preserved board order across sorts.
...
- Agregado the people manager for task assignees.
...
- Agregado stale-aware iOS sync bookmarks, bookmark refresh, and coordinated sync-file reads/writes.
...
- Agregado Obsidian Dataview metadata import.
...
- Agregado Czech locale coverage and refreshed partial locale coverage.
...
- Agregado reusable core and mobile dependency install scripts for release workflows.
