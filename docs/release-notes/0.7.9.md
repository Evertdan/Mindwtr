...
- Agregado backup restore and Todoist import, expanded the desktop Obsidian integration with TaskNotes and live write-back, and se mejoró Apple-platform CloudKit startup manejo.
- Mejorado Android and mobile workflow stability with widget polish, safer auto-sync state manejo, and fewer duplicate conflict alerts.
...
## Escritorio & Integrations
- Agregado Obsidian TaskNotes soporte plus live updates and write-back for the desktop integration.
...
- Mejorado desktop UX with fallback accessibility labels, localized delete-undo copy, cleaner focus lists for waiting tasks, and removal of the redundant sidebar shortcuts button.

## Móvil, iOS & Android
- Agregado backup restore and Todoist import in the shared data layer and linked the CloudKit Expo module for iOS builds.
...
- Mejorado Android widget readability with larger task text and a visible hidden-focus counter, while canceling pending checklist flushes on delete.

## Data, Sync & Cloud
- Agregado project and area restore actions, restored reliable area color editing, and preserved visible tasks when purging tombstones.
...
- Agregado backup restore and Todoist import guides, refreshed Obsidian wiki docs, and se actualizó sync and prior release-note documentation.
