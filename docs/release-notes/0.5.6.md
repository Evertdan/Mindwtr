...
- Focus/Agenda: reused TaskItem for consistent inline editing; se agregó details/compact toggle in the top-right controls.
...
## Core
- Referencia status workflow clarified and tested (clears action fields on transition).
- Search tests cover `status:reference` filtering.

## Historial completo de cambios (since 0.5.5)
