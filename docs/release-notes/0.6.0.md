...
- Escritorio UX polish: toast notifications, unsaved edit warnings, and clearer loading/disabled states during project and bulk actions.
...
- Page SQLite loads for se mejoró performance.
...
## Historial completo de cambios (since 0.5.9)
