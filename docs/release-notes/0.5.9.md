...
## Destacados
- Móvil inbox processing is more reliable and supports #tags alongside @contexts.
- Móvil search now opens the exact project/task you tapped.
...
- Agregado safe-area padding for Android nav bars in Settings, Review, Board, Waiting, Someday, and Referencia.
- Sync folder selection now validates writability and shows a clear read-only message.

## Historial completo de cambios (since 0.5.8)
