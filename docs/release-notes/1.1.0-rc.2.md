...
- Verify manual sync on desktop and mobile always reads the remote document, even when the unchanged-check cache says nothing cambió.
...
- Agregado an optional Android persistent "Quick add" notification for one-swipe capture from anywhere.
