...
- Check AI provider setup, structured output manejo, speech-to-text fallback behavior, and MCP/cloud task write paths.
...
- Use refreshed AI providers with stricter structured outputs, bounded retries, and se actualizó default models.
