...
- Móvil calendar planning feels more direct with body gestures, smoother week scrolling, clearer event details, day timeline quick add soporte, and tighter swipe behavior.
...
- Recurrence is more flexible and safer with weekly interval controls, a quarterly preset, better monthly interval manejo, and repaired edge cases for anchored recurring dates.
...
- Agregado a richer mobile Review workflow and se eliminó Review from the mobile menu tab now that it has a dedicated route.
...
- Mejorado desktop review interactions and se agregó review and area quick actions from desktop task menus.
...
- Agregado mobile calendar body gestures and se mejoró calendar event interactions.
- Smoothed mobile calendar week scrolling, aligned the initial calendar view mode, limited swipe gestures, se eliminó the extra day calendar add button, and allowed day timeline quick add.
- Agregado metadata autocomplete suggestions in mobile inbox processing and task editing.
- Agregado weekly recurrence interval controls and a quarterly recurrence preset.
- Used the monthly interval control consistently and covered recurrence repair edge cases.
- Agregado recurrence week and quarterly locale fallbacks.
...
- Agregado a local areas endpoint and preserved project IDs during local automation repair.
