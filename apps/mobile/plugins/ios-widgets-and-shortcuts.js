...
const addSiriShortcutsRegistrationToAppDelegate = (contents) => {
  ...
  // La reindexación de Spotlight debe ser impulsada por el propio camino de actualización de la aplicación, nunca
