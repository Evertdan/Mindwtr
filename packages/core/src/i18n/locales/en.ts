...
export const en: Record<string, string> = {
        ...
        'list.tasksDeleted': '{{count}} task(s) deleted',
  ...
  'projects.reorderNeedsDefaultSort': "Available when Sort is Default",
    ...
    'settings.timeFormat': 'Time format',
        ...
        'settings.menuDesc.tdah': 'Daily plan, nightly ritual, reminders',
        ...
        'tdahOnboarding.close': 'Close',
        'tdahOnboarding.back': 'Back',
        'tdahOnboarding.next': 'Next',
        'tdahOnboarding.promise.title': 'Your day, your watch, your ritual',
        'tdahOnboarding.promise.body': 'ADHD mode turns your phone and watch into executive support: Routines generate your day, your watch buzzes at every transition, and a nightly ritual closes today and sets up tomorrow.',
        'tdahOnboarding.promise.cta': 'Get started',
        'tdahOnboarding.ritual.title': 'Ritual hour',
        'tdahOnboarding.ritual.body': 'Pick when your day closes and tomorrow gets ready.',
        'tdahOnboarding.ritual.timeZoneLabel': 'Time zone',
        'tdahOnboarding.ritual.ritualHourLabel': 'Ritual hour',
        ...
        'tdahOnboarding.routine.title': 'Your first Routine',
        'tdahOnboarding.routine.body': 'Start from a Workday template, or skip — you can add one anytime.',
        'tdahOnboarding.routine.create': 'Use Workday template',
        'tdahOnboarding.routine.skip': 'Skip for now',
        'tdahOnboarding.permissions.title': 'Phone permissions',
        'tdahOnboarding.permissions.body': 'Each one is optional — nothing here blocks the mode from working.',
        'tdahOnboarding.permissions.notificationsTitle': 'Notifications',
        'tdahOnboarding.permissions.notificationsDesc': 'So reminders can reach you.',
        'tdahOnboarding.permissions.batteryTitle': 'Unrestricted battery',
        'tdahOnboarding.permissions.batteryDesc': 'Keeps the connection to your server alive.',
        'tdahOnboarding.permissions.calendarTitle': 'Calendar (optional)',
        'tdahOnboarding.permissions.calendarDesc': 'Used to stay quiet during your meetings.',
        'tdahOnboarding.permissions.request': 'Allow',
        'tdahOnboarding.permissions.statusGranted': 'Allowed',
        'tdahOnboarding.permissions.statusDenied': 'Not allowed',
        'tdahOnboarding.permissions.statusUndetermined': 'Not asked yet',
        'tdahOnboarding.permissions.continue': 'Continue',
        'tdahOnboarding.permissionNotice.title': 'No problem',
        'tdahOnboarding.permissionNotice.body': 'ADHD mode keeps working — you can turn this on later from settings.',
        'tdahOnboarding.permissionNotice.openSettings': 'Open settings',
        'tdahOnboarding.permissionNotice.continue': 'Continue',
        'tdahOnboarding.permissionNotice.notificationsTitle': 'Notifications are off',
        'tdahOnboarding.permissionNotice.notificationsRecovery': 'You can allow them anytime from your phone settings.',
        'tdahOnboarding.permissionNotice.batteryTitle': 'Battery restriction is on',
        'tdahOnboarding.permissionNotice.batteryRecovery': 'The connection may drop in the background — you can remove the restriction anytime from your phone settings.',
        'tdahOnboarding.permissionNotice.calendarTitle': 'Calendar is off',
        'tdahOnboarding.permissionNotice.calendarRecovery': 'Quiet-during-meetings won\'t work yet — you can allow it anytime from your phone settings.',
        'tdahOnboarding.done.title': "You're set",
        'tdahOnboarding.done.pending': 'Checking your server…',
        'tdahOnboarding.done.dayPlanReady': 'Tomorrow ({date}) is already generated with {count} activities.',
        'tdahOnboarding.done.reactivatedTitle': 'Welcome back',
        'tdahOnboarding.done.reactivatedBody': 'Your Activities and history are right where you left them.',
        'tdahOnboarding.done.errorTitle': 'Could not confirm',
        'tdahOnboarding.done.errorBody': 'We could not confirm the server state. Try again.',
        'tdahOnboarding.done.retry': 'Retry',
        'tdahOnboarding.done.finish': 'Go to Today',
        // Story 1.6 — T-01/T-02 ("Hoy"): the today timeline and Activity
        // detail/registration screens. Sibling to the tdahOnboarding.*/
        // settings.tdah.* namespaces above.
        'nav.tdahToday': 'Today',
        'tdahToday.title': 'Today',
        ...
        'tdahToday.loadError': 'Could not load your day.',
        ...
        'tdahToday.workBandTasks': '{count} task(s)',
        ...
        'tdahToday.workBandNotificationTitle': 'Sprint: {count} pending assigned task(s)',
        ...
        // Story 4.1 — the third origin: the grouped, read-only work band the
        // Jira origin materializes. Named on every surface that names an
        // origin, so a jira-origin Actividad can never render a blank badge.
        'tdahActivity.origin.jira': 'Jira',
        'tdahActivity.state.pending': 'Pending',
        'tdahActivity.state.started': 'Started',
        'tdahActivity.state.completed': 'Completed',
        'tdahActivity.state.missed': 'Not completed',
        'tdahActivity.state.limbo': 'In limbo',
        'tdahActivity.state.discarded': 'Discarded',
        'tdahActivity.detailTitle': 'Activity',
        'tdahActivity.createTitle': 'New activity',
        'tdahActivity.titlePlaceholder': 'What are you going to do?',
        'tdahActivity.startTimeLabel': 'Time (optional)',
        'tdahActivity.durationLabel': 'Duration in minutes (optional)',
        'tdahActivity.startedAtLabel': 'Started: {time}',
        'tdahActivity.completedAtLabel': 'Completed: {time}',
        'tdahActivity.actionStart': 'Start',
        'tdahActivity.actionComplete': 'Completed',
        ...
        'agenda.showMore': 'Show {{count}} more task(s)...',
        ...
        'settings.syncConflictMore': '+{{count}} more resolved conflict(s)',
        ...
        'mindSweep.summaryCount': 'You captured {{count}} item(s) into your Inbox.',
    ...
    'obsidian.bringIntoMindwtrFailed': 'Could not add the task to Mindwtr.',
        ...
        // screens. Keeps the existing settings.tdah.*/tdahOnboarding.* keys
        // untouched (still used by activation and the mobile onboarding
        // shortcut). Weekday names are resolved via `getLocalizedWeekdayLabels`
        // (Intl-backed, same convention as the Task recurrence UI) rather than
        // duplicated here; ordinal labels reuse `recurrence.ordinal.*`.
        ...
        'tdahRoutines.list.emptyBody': 'A Routine is the template for a type of day: the calendar pattern it applies to, and the ordered Blocks that make up that day.',
        ...
        'tdahRoutines.list.deleteConfirmBody': "Already-generated days won't change — this applies from the next generation onward.",
        ...
        'tdahRoutines.editor.editBanner': "Already-generated days don't change — this applies from the next generation onward.",
        'tdahRoutines.editor.nameLabel': 'Name',
        'tdahRoutines.editor.namePlaceholder': 'e.g. "Workday", "Saturday home"',
        ...
        'tdahRoutines.editor.previewHint': 'Days this Routine would win, calculated by your server.',
        ...
        'tdahRoutines.editor.blocksEmpty': 'No Blocks yet — this Routine generates an empty day.',
        ...
        // T-13 (story 4.1) — the Jira work origin. The token is write-only:
        // it is entered once, encrypted at rest on the server, and never sent
        // back, so every string here talks about the connection, never about
        // the secret's value.
        ...
        // Story 4.3 — T-12 (no molestar) y el chip DND de T-01. FR-12/AD-8:
        // el teléfono observa y el VPS decide, así que toda esta copy describe
        // un estado ya resuelto por el servidor, nunca una decisión local.
        'tdahToday.dndChip': 'DND \u00b7 until {time}',
        'tdahToday.dndChipA11y': 'Do not disturb is on until {time}. Opens do-not-disturb settings.',
        'tdahDnd.title': 'Do not disturb',
        // La promesa obligatoria de FR-12. Prohibido cualquier wording que
        // insinúe recuperación posterior ("we will resend", "you will get them
        // later"): el usuario TDAH apaga el DND en cuanto sospecha una avalancha.
        ...
        'tdahDnd.calendar.syncing': 'Reading your calendar\u2026',
        'tdahDnd.calendar.syncError': 'Could not send your calendar windows to your server.',
        'tdahDnd.calendar.detected': '{count} window(s) detected from your calendar',
        'tdahDnd.calendar.detectedEmpty': 'No busy events in your working hours right now.',
        'tdahDnd.calendar.readOnly': 'Windows detected from your calendar refresh on their own — change them in your calendar.',
        // Copy sin culpa: el permiso denegado es una opción legítima, no un fallo
        // del usuario. Nunca "you must grant" ni "permission error".
        'tdahDnd.calendar.permissionDenied': 'Calendar access is off, so only your manual windows apply. You can turn it on whenever you want.',
        'tdahDnd.calendar.permissionCta': 'Allow calendar access',
        'tdahDnd.calendar.permissionSettings': 'Open system settings',
        // Estado PERMANENTE de la PWA (doc 06): no es una degradación temporal
        // ni algo que el usuario pueda activar aquí.
        ...
        'tdahDnd.settings.entry': 'Do not disturb',
        'tdahDnd.settings.entryHint': 'Meetings silence your reminders.',
};
