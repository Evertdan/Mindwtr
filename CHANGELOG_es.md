...
Las notas de lanzamiento canónicas viven en [docs/release-notes/](docs/release-notes/README.md).

Este archivo intencionalmente se mantiene como un índice corto para que no se desvíe de las notas por lanzamiento.

## Últimos lanzamientos

- [No lanzado](docs/release-notes/unreleased.md)
...
- [Índice completo de notas de lanzamiento](docs/release-notes/README.md)
